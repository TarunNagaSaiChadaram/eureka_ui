...
@Component({
  selector: 'app-folderstructure-assignment',
  imports: [],
  templateUrl: './folderstructure-assignment.html',
  styleUrl: './folderstructure-assignment.css'
})
export class FolderstructureAssignment {
data ={
  "name": "project1",
  "isFolder": true,
  "items": [
